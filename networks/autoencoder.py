...
flags.DEFINE_integer('inputDim', 28*28, 'Input dimension') # 28*28 for BasicANN example
...
def run_training():
  ...
  with tf.Graph().as_default():
    ...
    train_op = BasicANN.training(loss, FLAGS.learning_rate)

    # Add the Op to compare the logits to the labels during evaluation.
    eval_correct = BasicANN.evaluation(logits, labels_placeholder)
