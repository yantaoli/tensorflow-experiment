...
class UserDataTestSet(object):
  def __init__(self, train_users, train_users_header, one_hot=False):
    ...
    # TODO import the look up table and nomalization scale
    self.train_users_str2ind, self.train_users_ind2str = input_util.tokenizeByColumn(train_users,[4,6,8,9,10,11,12,13,14])
    ...
    self._input = train_users[:, range(1,14)].astype(float)
